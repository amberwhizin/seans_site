    ...
    <Container>
      ...
      <TextContainer>
        <Description isReadMoreClicked={isReadMoreClicked}>
          ...
          BC, I initially struggled, but once I started tutoring with Sean
          again, I went from a B to an A in the class within a month. Although I
          still receive tutoring from Sean, I feel as though he has not only
          supported me as I learn new concepts, but provided me with the skills
          and interest in calculus necessary to be self-sufficient and
          independently receive a good grade in future math classes. In
          comparison to typical tutors, Sean doesn’t create dependent students;
          rather, he inspires students to enjoy math at a fundamental and
          conceptual level and develop the skills necessary to thrive
          independently in the future. Sean inspired me to think about math and
          calculus with a whole new perspective that I had never even considered
          before starting tutoring. He taught me how to apply concepts to basic
          facts of life that I’d never realized were intrinsically related to
          math, or in many ways, a product of it. Though I still feel like
          receiving tutoring from Sean is highly beneficial to my scores and
          understanding, I can also recognize the difference in my independent
          ability to retain, comprehend, and fundamentally understand new
          concepts since starting tutoring with Sean. He incited a passion and
          interest in mathematics that turned mundane, tedious, and seemingly
          incomprehensible concepts into fascinating ones. Besides calculus,
          Sean has also helped me in AP Physics. He has a wide variety of skills
          and knowledge that allows him to tutor various concepts and subjects.
          Sean is an all around intuitive, insightful, and smart individual who
